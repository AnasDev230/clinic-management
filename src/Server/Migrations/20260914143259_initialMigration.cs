        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    RequiresAppointment = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    SortOrder = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_medical_services_service_categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_follow_ups_appointments_AppointmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    NextVisitRecommended = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    NextVisitNotes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    FinalAmount = table.Column<decimal>(type: "numeric(15,2)", precision: 15, scale: 2, nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxAmount = table.Column<decimal>(type: "numeric(15,2)", precision: 15, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<Guid>(type: "uuid", nullable: false),
                    DoctorId = table.Column<Guid>(type: "uuid", nullable: false),
                    TestName = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    TestCategory = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_lab_tests_doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_lab_tests_doctors_OrderedByDoctorId",
                        column: x => x.OrderedByDoctorId,
                        principalTable: "doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_lab_tests_doctors_PerformedByDoctorId",
                        column: x => x.PerformedByDoctorId,
                        principalTable: "doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_lab_tests_patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_lab_tests_visits_VisitId",
                        column: x => x.VisitId,
                        principalTable: "visits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_visit_vitals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_visit_vitals_visits_VisitId",
                        column: x => x.VisitId,
                        principalTable: "visits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    MedicalServiceId = table.Column<Guid>(type: "uuid", nullable: true),
                    Quantity = table.Column<decimal>(type: "numeric(12,3)", precision: 12, scale: 3, nullable: false, defaultValue: 1m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_invoice_items_medical_services_MedicalServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalRange = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_lab_results_lab_tests_LabTestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Frequency = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Duration = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_follow_ups_AppointmentId",
                table: "follow_ups",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_follow_ups_FollowUpDate",
                table: "follow_ups",
                column: "FollowUpDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_invoice_items_MedicalServiceId",
                table: "invoice_items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lab_tests_OrderedByDoctorId",
                table: "lab_tests",
                column: "OrderedByDoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_lab_tests_OrderedDate",
                table: "lab_tests",
                column: "OrderedDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lab_tests_PerformedByDoctorId",
                table: "lab_tests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lab_tests_VisitId",
                table: "lab_tests",
                column: "VisitId");

            migrationBuilder.CreateIndex(
                name: "IX_medical_services_CategoryId",
                table: "medical_services",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_medical_services_IsActive",
                table: "medical_services",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_medical_services_Name",
                table: "medical_services",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_medical_services_SortOrder",
                table: "medical_services",
                column: "SortOrder");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_visit_diagnoses_VisitId",
                table: "visit_diagnoses",
                column: "VisitId");

            migrationBuilder.CreateIndex(
                name: "IX_visit_vitals_VisitId",
                table: "visit_vitals",
                column: "VisitId",
                unique: true);
