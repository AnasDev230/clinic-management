...
{
    public CreateDoctorValidator(IDoctorRepository repository)
    {
        ...
        RuleFor(x => x.Email)
            ...
            .WithMessage("A doctor with the same email already exists.");
        ...
        RuleFor(x => x.LicenseNumber)
            ...
            .MustAsync(async (license, _) => !await repository.ExistsByLicenseAsync(license))
            .WithMessage("A doctor with the same license number already exists.");
